...
import logging
import os
#TODO how to replace cohere with sentence transformer 
import cohere
import yaml
...
if __name__ == "__main__":
    ...
    resume_dict = read_config(
        READ_RESUME_FROM
        + "/Resume-bruce_wayne_fullstack.pdf2191c8cc-c98f-4391-9048-e608b015e7cf.json"
    )
    # print("Hey",resume_dict,"\n",)
    job_dict = read_config(
        READ_JOB_DESCRIPTION_FROM
        + "/JobDescription-job_desc_full_stack_engineer.pdf13bb9521-655e-4eac-9072-ba0ea9fb9403.json"
    )
